...
{
    /// <inheritdoc />
    public partial class FixVocherDateMapping : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HeadCode = table.Column<int>(type: "integer", nullable: true),
                    HeadLevel = table.Column<int>(type: "integer", nullable: true),
                    HeadName = table.Column<string>(type: "text", nullable: true),
                    HeadType = table.Column<string>(type: "text", nullable: true),
                    HeadCodeName = table.Column<string>(type: "text", nullable: true),
                    IsGl = table.Column<bool>(type: "boolean", nullable: true),
                    IsTransaction = table.Column<bool>(type: "boolean", nullable: true),
                    ParentHead = table.Column<int>(type: "integer", nullable: true),
                    PHeadName = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    VocherDate = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    AccountHeadId = table.Column<int>(type: "integer", nullable: false),
                    BalanceType = table.Column<int>(type: "integer", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OpeningBalance_ChartOfAccount_AccountHeadId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Attendee = table.Column<string>(type: "text", nullable: false),
                    AttendeeType = table.Column<string>(type: "text", nullable: false),
                    AttendeeStatus = table.Column<string>(type: "text", nullable: false),
                    CreatedBy = table.Column<string>(type: "text", nullable: true),
                    CreatedDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedBy = table.Column<string>(type: "text", nullable: true),
                    UpdatedDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RelatedAgendaItemTitle = table.Column<string>(type: "text", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MeetingAgendaDecision", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MeetingAgendaDecision_Meetings_MeetingId",
                        column: x => x.MeetingId,
                        principalTable: "Meetings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SequenceNo = table.Column<string>(type: "text", nullable: false),
                    CreatedBy = table.Column<string>(type: "text", nullable: true),
                    CreatedDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedBy = table.Column<string>(type: "text", nullable: true),
                    UpdatedDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Customer_CustomerGroups_CustomerGroupId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StateId = table.Column<int>(type: "integer", nullable: false),
                    CityId = table.Column<int>(type: "integer", nullable: false),
                    SupplierGroupId = table.Column<int>(type: "integer", nullable: false),
                    Address = table.Column<string>(type: "text", nullable: true),
                    RegionId = table.Column<int>(type: "integer", nullable: false),
                    PostalCode = table.Column<string>(type: "text", nullable: true),
                    Phone = table.Column<string>(type: "text", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Supplier_SupplierGroups_SupplierGroupId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Warehouse_State_StateId",
                        column: x => x.StateId,
                        principalTable: "State",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GstPercentage = table.Column<int>(type: "integer", nullable: true),
                    GST = table.Column<decimal>(type: "numeric", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PurchaseLineItems_Purchases_PurchasesId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MeetingAgendaDecision_MeetingId",
                table: "MeetingAgendaDecision",
                column: "MeetingId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OpeningBalance_AccountHeadId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PurchaseLineItems_PurchasesId",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_SaleLineItems_Sales_SalesId",
                table: "SaleLineItems",
                column: "SalesId",
